...
interface ContractRegistryClientInterface extends ethers.utils.Interface {
  functions: {
...
export class ContractRegistryClient extends Contract {
  ...
  interface: ContractRegistryClientInterface;
