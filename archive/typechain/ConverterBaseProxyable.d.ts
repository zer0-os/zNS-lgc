...
interface ConverterBaseProxyableInterface extends ethers.utils.Interface {
  functions: {
...
export class ConverterBaseProxyable extends Contract {
  ...
  interface: ConverterBaseProxyableInterface;
