...
interface DynamicLiquidTokenConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class DynamicLiquidTokenConverter extends Contract {
  ...
  interface: DynamicLiquidTokenConverterInterface;
