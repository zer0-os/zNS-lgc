...
interface DynamicLiquidTokenConverterProxyableInterface
  ...
  encodeFunctionData(
    functionFragment: "setMarketCapThreshold",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setMinimumWeight",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ReserveTokenWeightUpdate(uint32,uint32,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ReserveTokenWeightUpdate"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenRateUpdate"): EventFragment;
}

export class DynamicLiquidTokenConverterProxyable extends Contract {
  ...
  functions: {
    ...
    setMarketCapThreshold(
      _marketCapThreshold: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setMarketCapThreshold(uint256)"(
      _marketCapThreshold: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    setMinimumWeight(
      _minimumWeight: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setMinimumWeight(uint32)"(
      _minimumWeight: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
