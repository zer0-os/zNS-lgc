...
interface ILiquidTokenConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class ILiquidTokenConverter extends Contract {
  ...
  interface: ILiquidTokenConverterInterface;
