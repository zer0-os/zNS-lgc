...
interface ITypedConverterFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ITypedConverterFactory extends Contract {
  ...
  interface: ITypedConverterFactoryInterface;
