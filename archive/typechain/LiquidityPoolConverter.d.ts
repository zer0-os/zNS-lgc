...
interface LiquidityPoolConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidityPoolConverter extends Contract {
  ...
  interface: LiquidityPoolConverterInterface;
