...
interface LiquidityPoolV1ConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidityPoolV1Converter extends Contract {
  ...
  interface: LiquidityPoolV1ConverterInterface;
