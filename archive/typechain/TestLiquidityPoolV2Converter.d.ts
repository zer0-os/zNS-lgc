...
interface TestLiquidityPoolV2ConverterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setExternalRateUpdateTime(uint256)": FunctionFragment;
    ...
    "setReserveWeight(address,uint32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setExternalRateUpdateTime",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setReserveWeight",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TestLiquidityPoolV2Converter extends Contract {
  ...
  interface: TestLiquidityPoolV2ConverterInterface;
  ...
  functions: {
    ...
    setExternalRateUpdateTime(
      _externalRateUpdateTime: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setExternalRateUpdateTime(uint256)"(
      _externalRateUpdateTime: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    "setReserveWeight(address,uint32)"(
      _reserveToken: string,
      _weight: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
