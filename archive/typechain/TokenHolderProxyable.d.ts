...
interface TokenHolderProxyableInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenHolderProxyable extends Contract {
  ...
  interface: TokenHolderProxyableInterface;
