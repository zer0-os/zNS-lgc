...
import type { ConverterBaseProxyable } from "../ConverterBaseProxyable";

export class ConverterBaseProxyable__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ConverterBaseProxyable {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as ConverterBaseProxyable;
  }
}
