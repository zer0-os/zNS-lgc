...
contract RegistrarAdminClaim is
  IRegistrar,
  OwnableUpgradeable,
  ERC721PausableUpgradeable
{
  ...
  function adminTransfer(uint256 domainId, address owner) external onlyOwner {
    address currentOwner = ownerOf(domainId);
    _transfer(currentOwner, owner, domainId);
  }
