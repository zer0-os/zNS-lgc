...
const logger = utilities_1.getLogger("scripts::deploy-auth-controller");
async function main() {
    ...
    const controllerFactory = new typechain_1.AuthBasicController__factory(deploymentAccount);
