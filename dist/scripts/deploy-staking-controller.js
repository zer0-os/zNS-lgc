...
const logger = utilities_1.getLogger("scripts::deploy-staking-controller");
...
async function main() {
    ...
    const instance = await hardhat_1.upgrades.deployProxy(controllerFactory, [registrar.address, tokenAddress], {
