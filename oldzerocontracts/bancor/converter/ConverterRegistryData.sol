    ...
    ContractRegistryClient
{
    ...
    function removeConvertibleToken(
        ...
        if (list.items.array.length == 0) {
            address lastConvertibleToken =
                convertibleTokens.array[convertibleTokens.array.length - 1];
    ...
    function getConvertibleTokenSmartToken(
        ...
        return
            IConverterAnchor(
                convertibleTokens.table[address(_convertibleToken)].items.array[
                    _index
                ]
            );
    }
    ...
    function isConvertibleTokenSmartToken(
        ...
        return
            convertibleTokens.table[address(_convertibleToken)].items.table[
                _value
            ]
                .valid;
    }
