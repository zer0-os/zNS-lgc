...
import "./ERC20TokenProxyable.sol";
import "./interfaces/IDSToken.sol";
import "../utility/OwnedProxyable.sol";
 ...
 *
 */
contract DSTokenProxyable is IDSToken, ERC20TokenProxyable, OwnedProxyable {
    ...
    function initialize(
        ...
        __Owned_initialize();
        ERC20TokenProxyable.initialize(_name, _symbol, _decimals, 0);
    }
    ...
    function transfer(address _to, uint256 _value)
        public
        override(IERC20Token, ERC20TokenProxyable)
        returns (bool)
    {
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _value
    ) public override(IERC20Token, ERC20TokenProxyable) returns (bool) {
