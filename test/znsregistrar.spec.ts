...
import { ZNSRegistrar, ZNSRegistrar__factory } from "../typechain";
...
describe("ZNS Registrar", () => {
  let accounts: SignerWithAddress[];
  let registryFactory: ZNSRegistrar__factory;
  let registry: ZNSRegistrar;
  ...
  beforeEach("deploys", async () => {
    registryFactory = new ZNSRegistrar__factory(creator);
