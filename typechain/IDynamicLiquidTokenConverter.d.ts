...
interface IDynamicLiquidTokenConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class IDynamicLiquidTokenConverter extends Contract {
  ...
  interface: IDynamicLiquidTokenConverterInterface;
