...
interface ILiquidityPoolV2ConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class ILiquidityPoolV2Converter extends Contract {
  ...
  interface: ILiquidityPoolV2ConverterInterface;
