...
interface LiquidTokenConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidTokenConverter extends Contract {
  ...
  interface: LiquidTokenConverterInterface;
