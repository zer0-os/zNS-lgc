...
interface TestBancorNetworkInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getReturnNew()": FunctionFragment;
    "getReturnOld()": FunctionFragment;
    "isV28OrHigherConverterExternal(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getReturnNew",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getReturnOld",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "isV28OrHigherConverterExternal",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class TestBancorNetwork extends Contract {
  ...
  interface: TestBancorNetworkInterface;
  ...
  functions: {
    ...
    getReturnNew(overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;

    "getReturnNew()"(
      overrides?: CallOverrides
    ): Promise<[BigNumber, BigNumber]>;

    getReturnOld(overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
    ...
    "isV28OrHigherConverterExternal(address)"(
      _converter: string,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    getReturnNew(overrides?: CallOverrides): Promise<BigNumber>;

    "getReturnNew()"(overrides?: CallOverrides): Promise<BigNumber>;

    getReturnOld(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getReturnNew(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "getReturnNew()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getReturnOld(overrides?: CallOverrides): Promise<PopulatedTransaction>;
