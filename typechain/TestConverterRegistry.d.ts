...
interface TestConverterRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export class TestConverterRegistry extends Contract {
  ...
  interface: TestConverterRegistryInterface;
