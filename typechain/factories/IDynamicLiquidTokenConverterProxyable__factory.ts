...
import type { IDynamicLiquidTokenConverterProxyable } from "../IDynamicLiquidTokenConverterProxyable";

export class IDynamicLiquidTokenConverterProxyable__factory {
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IDynamicLiquidTokenConverterProxyable;
  }
}
