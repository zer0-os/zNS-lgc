...
import type { IDynamicLiquidTokenConverter } from "../IDynamicLiquidTokenConverter";

export class IDynamicLiquidTokenConverter__factory {
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IDynamicLiquidTokenConverter;
  }
}
